  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[#B0B0B0] text-sm font-forma mt-1 max-h-0 overflow-hidden opacity-0 group-hover:max-h-10 group-hover:opacity-100 transition-all duration-300">
          {tech.subtitle}
        </p>
      </div>
    </motion.div>
